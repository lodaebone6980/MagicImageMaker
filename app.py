...
2. 캐릭터 (일관된 스타일 유지):
   ...
   - 표정 스타일: 심플한 이모티콘 스타일 (^_^, >_<, :D 같은 느낌)
   - 피부: 순수한 하얀색
...
[고정 스타일]
2D animation, simple white round circle face, dot eyes and small mouth, simple emoticon-style expressions, thin elongated white body, long slender limbs, colorful costumes, detailed 2D background, Korean keywords (2-3).
""",
        "역사": """
...
[고정 스타일]
2D animation, simple white round circle face, dot eyes and small mouth, simple emoticon-style expressions, thin elongated white body, long slender limbs, era-appropriate costumes, detailed 2D background, Korean keywords (2-3).
""",
        "과학": """
...
[고정 스타일]
2D animation, simple white round circle face, dot eyes and small mouth, simple emoticon-style expressions, thin elongated white body, long slender limbs, science/tech costumes, detailed 2D background, Korean keywords (2-3).
""",
        "커스텀 (직접 입력)": """
무조건 2D 애니메이션 스타일. 심플한 동그란 하얀색 얼굴 캐릭터로 설명이 잘되는 화면 자료 느낌.
